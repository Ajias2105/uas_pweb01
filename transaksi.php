...
if($query) {
			echo '<script>alert("Pesanan-mu berhasil terkirim, Terimakasih sudah berlangganan di Ajieeestore.id");
...
<title>Top Up Mobile Legends | Ajieeestore.id</title>
	...
	<div class="row">
		<div class="col-md-8 mx-auto">
			<div class="contact-form">
				<h1>AjieeeStore.id</h1>
				<p class="hint-text">Platform Top Up Game Termurah di Indonesia. Penuhi Kebutuhan Gaming Mu Bersama AjieeeStore.id Store Specialist Game Mobile Legends No.1.</p>
				<form action="" method="post">
					...
					<div class="form-group">
						<input type="emailx" class="form-control" placeholder="Ketikan Alamat Email" id="inputalamatemail" name="alamat_email" required>
					</div>
					<script>
